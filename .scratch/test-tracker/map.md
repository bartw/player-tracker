...
- [Build the tests page](issues/03-build-tests-page.md) — /tests live in production and verified: Δ% table → player cards, station-style test-day entry with per-station merge saves; domain/I-O split keeps the SDK out of the client bundle; env var on Vercel.

**Destination reached 2026-07-12** — no open tickets remain.
